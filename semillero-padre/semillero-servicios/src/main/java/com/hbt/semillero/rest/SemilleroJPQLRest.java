...
public class SemilleroJPQLRest {
	...
	public String obtenerUnComic() {
		...
		try {
			...
			queryUnComicConParametro.setParameter("estadoComic", EstadoEnum.ENABLED);
...
//			comic = (Comic) queryUnComicConException2.getSingleResult();
			...
			queryActualizar.setParameter("estado", EstadoEnum.ENABLED);
			...
			queryActualizarVarios.setParameter("estado", EstadoEnum.ENABLED);
